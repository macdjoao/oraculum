...
# data.insert(name='Orc')
# data.update(actual_name='orc', new_name='hobbit')
# data.delete(name='Orc')

data = GradeRepository()
# data.insert(name='paladin')
# data.insert(name='Archer')
# data.update(actual_name='paladin', new_name='wizard')
# data.delete(name='Archer')
# print(data.select_all())
print(data.select_one(name='mage'))
